...
REGISTRY_WSJCPP_RESOURCE_FILE(RES_html_images_teams_unknown_svg)

const std::string &RES_html_images_teams_unknown_svg::getFilename() {
    static const std::string s = "html/images/teams/unknown.svg";
    return s;
}

const std::string &RES_html_images_teams_unknown_svg::getPackAs() {
    static const std::string s = "binary";
    return s;
}

const int RES_html_images_teams_unknown_svg::getBufferSize() {
    return 5633;
}

const char *RES_html_images_teams_unknown_svg::getBuffer() {
