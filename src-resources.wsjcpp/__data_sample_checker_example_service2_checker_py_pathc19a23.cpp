...
const std::string &RES___data_sample_checker_example_service2_checker_py_pathc19a23::getFilename() {
    static const std::string s = "./data_sample/checker_example_service2/checker.py";
    return s;
}
// ---------------------------------------------------------------------

const std::string &RES___data_sample_checker_example_service2_checker_py_pathc19a23::getPackAs() {
    static const std::string s = "binary";
    return s;
}
// ---------------------------------------------------------------------

const int RES___data_sample_checker_example_service2_checker_py_pathc19a23::getBufferSize() {
    return 3408;
}

// ---------------------------------------------------------------------

const char *RES___data_sample_checker_example_service2_checker_py_pathc19a23::getBuffer() {
