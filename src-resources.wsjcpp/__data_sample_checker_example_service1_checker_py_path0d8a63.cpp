...
const std::string &RES___data_sample_checker_example_service1_checker_py_path0d8a63::getFilename() {
    static const std::string s = "./data_sample/checker_example_service1/checker.py";
    return s;
}
// ---------------------------------------------------------------------

const std::string &RES___data_sample_checker_example_service1_checker_py_path0d8a63::getPackAs() {
    static const std::string s = "binary";
    return s;
}
// ---------------------------------------------------------------------

const int RES___data_sample_checker_example_service1_checker_py_path0d8a63::getBufferSize() {
    return 3408;
}

// ---------------------------------------------------------------------

const char *RES___data_sample_checker_example_service1_checker_py_path0d8a63::getBuffer() {
    static const unsigned char b[3408] = {
        ...
        0x20, 0x34, 0x31, 0x30, 0x31, 0x0a, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x20, 0x3d, 0x20, 
