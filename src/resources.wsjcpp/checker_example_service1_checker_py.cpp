...
#include <checker_example_service1_checker_py.h>

REGISTRY_WSJCPP_RESOURCE_FILE(RES_checker_example_service1_checker_py)

const std::string &RES_checker_example_service1_checker_py::getFilename() {
    static const std::string s = "checker_example_service1/checker.py";
    return s;
}

const std::string &RES_checker_example_service1_checker_py::getPackAs() {
    static const std::string s = "binary";
    return s;
}

const int RES_checker_example_service1_checker_py::getBufferSize() {
    return 3408;
}

const char *RES_checker_example_service1_checker_py::getBuffer() {
