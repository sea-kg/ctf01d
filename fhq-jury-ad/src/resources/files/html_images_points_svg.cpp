...
#include <html_images_points_svg.h>

REGISTRY_RESOURCE_FILE(RES_html_images_points_svg)

const std::string &RES_html_images_points_svg::filename() {
    static const std::string s = "html/images/points.svg";
    return s;
}

const int RES_html_images_points_svg::bufferSize() {
    return 2979;
}

const char *RES_html_images_points_svg::buffer() {
